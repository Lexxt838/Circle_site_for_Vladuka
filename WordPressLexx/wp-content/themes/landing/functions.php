...
function landing_scripts() {
	...
	wp_enqueue_script( 'landing-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'landing-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
///////////////////////// f e a t u r e s /////////////////////////////////
function create_aditional_post_type() {
  register_post_type( 'aditional',
    array(
      'labels' => array(
        'name' => __( '_Features' ),
        'singular_name' => __( 'aditional' )
      ),
      'public' => true,
...
add_action( 'init', 'create_aditional_post_type' ) ;
